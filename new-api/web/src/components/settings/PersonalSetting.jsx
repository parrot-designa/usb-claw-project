...
const PersonalSetting = () => {
  ...
  const loadPasskeyStatus = async () => {
    try {
      const res = await API.get('user/passkey');
  ...
  const handleRegisterPasskey = async () => {
    ...
    try {
      const beginRes = await API.post('user/passkey/register/begin');
  ...
  const handleRemovePasskey = async () => {
    ...
    try {
      const res = await API.delete('user/passkey');
  ...
  const bindWeChat = async () => {
    ...
    const res = await API.post('oauth/wechat/bind', {
  ...
  const changePassword = async () => {
    ...
    const res = await API.put(`user/self`, {
  ...
  const sendVerificationCode = async () => {
    ...
    const res = await API.get(
      `verification?email=${inputs.email}&turnstile=${turnstileToken}`,
    );
    const { success, message } = res.data;
    if (success) {
  ...
  const bindEmail = async () => {
    ...
    setLoading(true);
    const res = await API.post('oauth/email/bind', {
      email: inputs.email,
  ...
  const saveNotificationSettings = async () => {
    try {
      const res = await API.put('user/setting', {
